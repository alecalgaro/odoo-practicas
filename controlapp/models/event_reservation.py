...
class EventReservation(models.Model):
    ...
    def _check_dates(self):
        """
        Metodo para validar que la fecha y hora de inicio no sea anterior a la fecha y hora actual,
        y que la fecha y hora de finalizacion no sea anterior a la fecha y hora de inicio.
        """
        for record in self:
    ...
    def _check_overlap(self):
        """
        Metodo para validar que no existan eventos registrados en el mismo dia y horario 
    ...
    def action_print_report(self):
        """
        Metodo para generar un reporte en PDF con la información de la reserva.
        """
